        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
          {skills.map((skill) => {
            ...
            return (
              <div
                key={skill.title}
                className="group rounded-3xl border border-slate-800 bg-slate-900/70 p-8 backdrop-blur transition-all duration-500 hover:-translate-y-2 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10"
              >
