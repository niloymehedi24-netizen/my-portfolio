        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-slate-400">
              ...
              My focus is always on writing clean code, creating intuitive user
              experiences and continuously improving my skills.
            </p>

            <p className="mt-6 leading-8 text-slate-400">
              I believe that every project is an opportunity to learn something
              new. Whether it&apos;s solving challenging problems or exploring
              the latest technologies, I&apos;m always excited to grow as a
              developer.
            </p>
